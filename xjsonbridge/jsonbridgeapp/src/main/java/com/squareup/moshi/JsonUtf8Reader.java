...
final class JsonUtf8Reader extends JsonReader {
  ...
  JsonUtf8Reader(BufferedSource source) {
    ...
    pushScope(com.squareup.moshi.JsonScope.EMPTY_DOCUMENT);
  }
  ...
  @Override public void beginArray() throws IOException {
    ...
    if (p == PEEKED_BEGIN_ARRAY) {
      pushScope(com.squareup.moshi.JsonScope.EMPTY_ARRAY);
  ...
  @Override public void beginObject() throws IOException {
    ...
    if (p == PEEKED_BEGIN_OBJECT) {
      pushScope(com.squareup.moshi.JsonScope.EMPTY_OBJECT);
      peeked = PEEKED_NONE;
    } else {
  ...
  private int doPeek() throws IOException {
    ...
    if (peekStack == com.squareup.moshi.JsonScope.EMPTY_ARRAY) {
      scopes[stackSize - 1] = com.squareup.moshi.JsonScope.NONEMPTY_ARRAY;
    } else if (peekStack == com.squareup.moshi.JsonScope.NONEMPTY_ARRAY) {
    ...
    } else if (peekStack == com.squareup.moshi.JsonScope.EMPTY_OBJECT || peekStack == com.squareup.moshi.JsonScope.NONEMPTY_OBJECT) {
      scopes[stackSize - 1] = com.squareup.moshi.JsonScope.DANGLING_NAME;
      // Look for a comma before the next element.
      if (peekStack == com.squareup.moshi.JsonScope.NONEMPTY_OBJECT) {
        int c = nextNonWhitespace(true);
        buffer.readByte(); // Consume '}' or ','.
        switch (c) {
          case '}':
    ...
    } else if (peekStack == com.squareup.moshi.JsonScope.DANGLING_NAME) {
      scopes[stackSize - 1] = com.squareup.moshi.JsonScope.NONEMPTY_OBJECT;
    ...
    } else if (peekStack == com.squareup.moshi.JsonScope.EMPTY_DOCUMENT) {
      scopes[stackSize - 1] = com.squareup.moshi.JsonScope.NONEMPTY_DOCUMENT;
    } else if (peekStack == com.squareup.moshi.JsonScope.NONEMPTY_DOCUMENT) {
    ...
    } else if (peekStack == com.squareup.moshi.JsonScope.CLOSED) {
    ...
    switch (c) {
      ...
      case ',':
        ...
        if (peekStack == com.squareup.moshi.JsonScope.EMPTY_ARRAY || peekStack == com.squareup.moshi.JsonScope.NONEMPTY_ARRAY) {
          checkLenient();
  ...
  @Override public void close() throws IOException {
    peeked = PEEKED_NONE;
    scopes[0] = com.squareup.moshi.JsonScope.CLOSED;
    stackSize = 1;
    buffer.clear();
    source.close();
  }
