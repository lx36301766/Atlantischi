...
public abstract class JsonAdapter<T> {
  ...
  public final com.squareup.moshi.JsonAdapter<T> serializeNulls() {
    final com.squareup.moshi.JsonAdapter<T> delegate = this;
    return new com.squareup.moshi.JsonAdapter<T>() {
   ...
   */
  public com.squareup.moshi.JsonAdapter<T> indent(final String indent) {
    if (indent == null) {
  ...
  public interface Factory {
     ...
     */
    @Nullable
    com.squareup.moshi.JsonAdapter<?> create(Type type, Set<? extends Annotation> annotations, Moshi moshi);
  }
}
