...
/**
 * the default implementation class of the interfacea IRefreshStatus, and the class should always be rewritten
 */
public class RefreshView extends ImageView implements IRefreshStatus {
    ...
    public void refreshing() {
        ...
        AnimationDrawable drawable = (AnimationDrawable) getResources().getDrawable(R.drawable.animation_list_loading);
        drawable.start();
