...
package com.lx.testandroid.recyclerview.observablescrollview;
...
public class ObservableRecyclerView extends RecyclerView implements Scrollable {
            ...
            switch (ev.getActionMasked()) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    if (getCurrentScrollY() - diffY <= 0) {
                        ...
                        // Apps can setter the interception target other than the direct parent.
                        ...
                        if (parent.onInterceptTouchEvent(event)) {
                            ...
                            // Return this onTouchEvent() first and setter ACTION_DOWN event for parent
     ...
     * This method checks which LayoutManager is setter,
