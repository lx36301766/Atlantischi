...
fun constructRectangle(area: Int): IntArray {
    ...
    val h = area / w
    return intArrayOf(h, w)
}

fun main(args: Array<String>) {
    println(constructRectangle(2).contentToString())
    println(constructRectangle(9).contentToString())
    println(constructRectangle(10).contentToString())
    println(constructRectangle(24).contentToString())
    println(constructRectangle(500).contentToString())
}
