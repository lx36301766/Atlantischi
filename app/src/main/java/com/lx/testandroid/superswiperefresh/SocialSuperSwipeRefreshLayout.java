package com.lx.testandroid.superswiperefresh;

import com.lx.testandroid.recyclerview.layoutmanager.SocialRecyclerLayoutManager;
import com.lx.testandroid.recyclerview.layoutmanager.SocialRecyclerView;
...
public class SocialSuperSwipeRefreshLayout extends ViewGroup {
    ...
    public SocialSuperSwipeRefreshLayout(Context context) {
        this(context, null);
    }

    @SuppressWarnings("deprecation")
    public SocialSuperSwipeRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void createHeaderViewContainer() {
        ...
        defaultProgressView.setBackgroundColor(0x8899f009);
        mHeadViewContainer.setBackgroundColor(0x88990009);
        mHeadViewContainer.addView(defaultProgressView, layoutParams);
        MarginLayoutParams lp = new MarginLayoutParams(LayoutParams.WRAP_CONTENT, 30);
        addView(mHeadViewContainer, lp);
    }
    ...
    protected void onLayout(boolean changed, int left, int top, int right,
        ...
        mHeadViewContainer.layout(
                (width / 2 - headViewWidth / 2), mCurrentTargetOffsetTop,
        ...
        mFooterViewContainer.layout(
                (width / 2 - footViewWidth / 2), height - pushDistance,
    ...
    public boolean isChildScrollToTop() {
        if (Build.VERSION.SDK_INT < 14) {
            ...
            if (mTarget instanceof SocialRecyclerView) {
                return true;
            } else {
     ...
     * @return
     */
    public boolean isChildScrollToTop2() {
        if (Build.VERSION.SDK_INT < 14) {
            if (mTarget instanceof AbsListView) {
                final AbsListView absListView = (AbsListView) mTarget;
                return !(absListView.getChildCount() > 0 && (absListView
    ...
    public boolean isChildScrollToBottom() {
        ...
        if (mTarget instanceof RecyclerView) {
            ...
            } else if (layoutManager instanceof SocialRecyclerLayoutManager) {
                SocialRecyclerLayoutManager socialRecyclerLayoutManager = (SocialRecyclerLayoutManager) layoutManager;
                if (socialRecyclerLayoutManager.findLastCompletelyVisibleItemPosition() == count - 1) {
                    return true;
                }
            }
            return false;
