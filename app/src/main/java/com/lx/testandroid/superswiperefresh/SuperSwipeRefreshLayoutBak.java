...
public class SuperSwipeRefreshLayoutBak extends ViewGroup {
    ...
    public SuperSwipeRefreshLayoutBak(Context context) {
        this(context, null);
    }

    @SuppressWarnings("deprecation")
    public SuperSwipeRefreshLayoutBak(Context context, AttributeSet attrs) {
        super(context, attrs);
