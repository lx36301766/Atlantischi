package com.atlantischi.reforceapk;
...
public class ReForceApp extends Application {
    ...
    protected void attachBaseContext(Context base) {
        ...
        try {
            ...
            String packageName = getPackageName();//当前apk的包名
            //下面两句不是太理解
            ...
            try {
                Object actObj = dLoader.loadClass("com.atlantischi.forceapkobj.MainActivity");
