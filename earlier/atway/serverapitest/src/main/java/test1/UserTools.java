...
public class UserTools {
    ...
    public static String getOriginalInfo(String key, String userId) {
        ...
        String m1 = result.substring(0,result.length() - Integer.parseInt(keys[0]));
        String m2 = result.substring(result.length() - Integer.parseInt(keys[0]), result.length());
...
//    }
    ...
    public static void main(String args[]) {
        ...
        System.out.println(UserTools.getOriginalInfo(key, jiamiUserID));
    }
}
