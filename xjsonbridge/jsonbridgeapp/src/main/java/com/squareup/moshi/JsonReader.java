...
public abstract class JsonReader implements Closeable {
  ...
  public static com.squareup.moshi.JsonReader of(BufferedSource source) {
  ...
  public final @Nullable Object readJsonValue() throws IOException {
    switch (peek()) {
      ...
      case BEGIN_OBJECT:
        Map<String, Object> map = new com.squareup.moshi.LinkedHashTreeMap<>();
        beginObject();
        while (hasNext()) {
    ...
    public static Options of(String... strings) {
      try {
        ...
        for (int i = 0; i < strings.length; i++) {
          com.squareup.moshi.JsonUtf8Writer.string(buffer, strings[i]);
  ...
  public enum Token {
     ...
     * and read using {@link com.squareup.moshi.JsonReader#beginArray}.
     */
    BEGIN_ARRAY,

    /**
     * The closing of a JSON array. Written using {@link JsonWriter#endArray}
     * and read using {@link com.squareup.moshi.JsonReader#endArray}.
     */
    END_ARRAY,

    /**
     * The opening of a JSON object. Written using {@link JsonWriter#beginObject}
     * and read using {@link com.squareup.moshi.JsonReader#beginObject}.
     */
    BEGIN_OBJECT,

    /**
     * The closing of a JSON object. Written using {@link JsonWriter#endObject}
     * and read using {@link com.squareup.moshi.JsonReader#endObject}.
     */
    END_OBJECT,
     ...
     * com.squareup.moshi.JsonReader#nextName}
     */
    NAME,
     ...
     * com.squareup.moshi.JsonReader#peek()} to signal that the JSON-encoded value has no more
     * tokens.
     */
    END_DOCUMENT
  }
