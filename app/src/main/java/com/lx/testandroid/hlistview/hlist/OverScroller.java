...
public class OverScroller {
    ...
    public OverScroller(Context context, Interpolator interpolator, boolean flywheel) {
        ...
        mFlywheel = flywheel;
        mScrollerX = new OverScroller.SplineOverScroller(context);
        mScrollerY = new OverScroller.SplineOverScroller(context);
    }
    ...
    public boolean isOverScrolled() {
        return ((!mScrollerX.mFinished &&
                         mScrollerX.mState != OverScroller.SplineOverScroller.SPLINE) ||
                        (!mScrollerY.mFinished &&
                                 mScrollerY.mState != OverScroller.SplineOverScroller.SPLINE));
    }
