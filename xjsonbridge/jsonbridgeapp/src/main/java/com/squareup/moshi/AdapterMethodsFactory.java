...
final class AdapterMethodsFactory implements JsonAdapter.Factory {
      ...
      @Override public void toJson(JsonWriter writer, @Nullable Object value) throws IOException {
        if (toAdapter == null) {
          ...
          try {
            ...
            throw new com.squareup.moshi.JsonDataException(cause + " at " + writer.getPath(), cause);
          }
        }
      }
  ...
  public static com.squareup.moshi.AdapterMethodsFactory get(Object adapter) {
    ...
    return new com.squareup.moshi.AdapterMethodsFactory(toAdapters, fromAdapters);
  }
  ...
  static AdapterMethod toAdapter(Object adapter, Method method) {
    ...
    if (parameterTypes.length >= 2
      ...
      boolean nullable = com.squareup.moshi.Util.hasNullable(parameterAnnotations[0]);
