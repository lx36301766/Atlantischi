package com.lx.testandroid.recyclerview.refreshrecyclerview;
...
public class RecyclerRefreshLayout extends ViewGroup
    ...
    protected void onCreateRefreshView() {
        ...
        if (mRefreshView instanceof IRefreshStatus) {
            ...
            throw new ClassCastException("the refreshView must implement the interfacea IRefreshStatus");
        }
     ...
     * Note
     *
     * @param refreshView  must implements the interfacea IRefreshStatus
     * @param layoutParams the with is always the match_parent， no matter how you setter
     *                     the height you need to setter a specific value
     */
