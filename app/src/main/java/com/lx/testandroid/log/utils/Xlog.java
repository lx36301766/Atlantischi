...
public class Xlog {
    ...
    private static String[] wrapInfo(String msg) {
        ...
        return new String[] { e.getClassName(), "[" + e.getMethodName() + ":" + e.getLineNumber() + "], msg=" + msg };
    }
    ...
    /**
     * wrap {@link Log#i(String, String)} with {@link String#format(String, Object...)}
     */
    ...
    /**
     * wrap {@link Log#v(String, String)} with {@link String#format(String, Object...)}
     */
    ...
    /**
     * wrap {@link Log#w(String, String)} with {@link String#format(String, Object...)}
     */
    ...
    /**
     * wrap {@link Log#e(String, String)} with {@link String#format(String, Object...)}
     */
