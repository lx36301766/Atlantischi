...
public abstract class AbsHListView extends AdapterView<ListAdapter> implements ViewTreeObserver.OnGlobalLayoutListener,
    ...
    /**
     * The list will automatically scroll to the bottom when a data setter change notification is received and only if the last item is
    ...
    /**
     * The data setter used to store unused views that should be reused during the next layout to avoid creating new ones
     */
    protected final AbsHListView.RecycleBin
            mRecycler = new AbsHListView.RecycleBin();
    ...
    /**
     * When the view is scrolling, this flag is setter to true to indicate subclasses that the drawing cache was enabled on the children
     */
     ...
     */
    private AbsHListView.FlingRunnable mFlingRunnable;
    ...
    /**
     * When setter to true, the list automatically discards the children's bitmap cache after scrolling.
     */
     ...
     * across a data setter change. If the item isn't found it will be unselected.
     */
     ...
     */
    private AbsHListView.CheckForLongPress mPendingCheckForLongPress;
     ...
     */
    private AbsHListView.CheckForKeyLongPress mPendingCheckForKeyLongPress;
    ...
    /**
     * The last scroll state reported to clients through {@link AbsHListView.OnScrollListener}.
     */
    private int mLastScrollState = AbsHListView.OnScrollListener.SCROLL_STATE_IDLE;
    ...
    // These two EdgeGlows are always setter and used together.
     ...
     */
    private AbsHListView.ListItemAccessibilityDelegate mAccessibilityDelegate;
     ...
     */
    private AbsHListView.SavedState mPendingSync;
    ...
    /**
     * The top-level view of a list item can implement this interfacea to allow itself to modify the bounds of the selection shown for
     * that item.
     */
    ...
    public AbsHListView( Context context, AttributeSet attrs ) {
        this( context, attrs, it.sephiroth.android.library.R.attr.hlv_absHListViewStyle );
    }
    ...
    public AbsHListView( Context context, AttributeSet attrs, int defStyle ) {
        ...
        TypedArray array = theme.obtainStyledAttributes( attrs, it.sephiroth.android.library.R.styleable.AbsHListView, defStyle, 0 );
        ...
        if( null != array ) {
            listSelector = array.getDrawable( it.sephiroth.android.library.R.styleable.AbsHListView_android_listSelector );
            drawSelectorOnTop = array.getBoolean( it.sephiroth.android.library.R.styleable.AbsHListView_android_drawSelectorOnTop, false );
            stackFromRight = array.getBoolean( it.sephiroth.android.library.R.styleable.AbsHListView_hlv_stackFromRight, false );
            scrollingCacheEnabled = array.getBoolean( it.sephiroth.android.library.R.styleable.AbsHListView_android_scrollingCache, true );
            transcriptMode = array.getInt( it.sephiroth.android.library.R.styleable.AbsHListView_hlv_transcriptMode, TRANSCRIPT_MODE_DISABLED );
            color = array.getColor( it.sephiroth.android.library.R.styleable.AbsHListView_android_cacheColorHint, 0 );
            smoothScrollbar = array.getBoolean( it.sephiroth.android.library.R.styleable.AbsHListView_android_smoothScrollbar, true );
            choiceMode = array.getInt( it.sephiroth.android.library.R.styleable.AbsHListView_android_choiceMode, ListView.CHOICE_MODE_NONE );
            array.recycle();
    ...
    /**
     * Returns the checked state of the specified position. The result is only valid if the choice mode has been setter to
    ...
    /**
     * Returns the currently checked item. The result is only valid if the choice mode has been setter to {@link #CHOICE_MODE_SINGLE}.
     *
    ...
    /**
     * Returns the setter of checked items in the list. The result is only valid if the choice mode has not been setter to
     ...
     *         list, or <code>null</code> if the choice mode is setter to {@link #CHOICE_MODE_NONE}.
     */
    ...
    /**
     * Returns the setter of checked items ids. The result is only valid if the choice mode has not been setter to
    ...
    /**
     * Clear any choices previously setter
     */
    ...
    /**
     * Sets the checked state of the specified position. The is only valid if the choice mode has been setter to
     * {@link #CHOICE_MODE_SINGLE} or {@link #CHOICE_MODE_MULTIPLE}.
     *
     * @param position
            ...
            if ( value && mChoiceMode == ListView.CHOICE_MODE_MULTIPLE_MODAL && mChoiceActionMode == null ) {
                if ( mMultiChoiceModeCallback == null ||
                    ...
                    throw new IllegalStateException( "AbsListView: attempted to start selection mode " +
                            ...
                            "supplied. Call setMultiChoiceModeListener to setter a callback." );
                }
     ...
     * choice mode is setter to {@link #CHOICE_MODE_MULTIPLE_MODAL}.
     *
     * @param listener
     ...
     *           the scroll listener
     */
    public void setOnScrollListener( AbsHListView.OnScrollListener l ) {
        mOnScrollListener = l;
        ...
        switch ( action ) {
            case AccessibilityNodeInfoCompat.ACTION_SCROLL_FORWARD: {
                if ( isEnabled() && getLastVisiblePosition() < getCount() - 1 ) {
                    ...
                    smoothScrollBy( viewportWidth, AbsHListView.PositionScroller.SCROLL_DURATION );
                    return true;
                }
            }
            return false;
    ...
    /**
     * When stack from bottom is setter to true, the list fills its content starting from the bottom of the view.
     *
    ...
    static class SavedState extends BaseSavedState {
        ...
        public static final Parcelable.Creator<AbsHListView.SavedState> CREATOR = new Parcelable.Creator<AbsHListView.SavedState>() {
    ...
    public Parcelable onSaveInstanceState() {
        ...
        AbsHListView.SavedState
                ss = new AbsHListView.SavedState( superState );
    ...
    public void onRestoreInstanceState( Parcelable state ) {
        ...
        AbsHListView.SavedState
                ss = (AbsHListView.SavedState) state;
    ...
    protected View obtainView( int position, boolean[] isScrap ) {
        ...
        if ( mAdapterHasStableIds ) {
            ...
            AbsHListView.LayoutParams lp;
            if ( vlp == null ) {
                lp = (AbsHListView.LayoutParams) generateDefaultLayoutParams();
            } else if ( !checkLayoutParams( vlp ) ) {
                lp = (AbsHListView.LayoutParams) generateLayoutParams( vlp );
            } else {
                lp = (AbsHListView.LayoutParams) vlp;
            }
        ...
        if ( mAccessibilityManager.isEnabled() ) {
            if ( mAccessibilityDelegate == null ) {
                mAccessibilityDelegate = new AbsHListView.ListItemAccessibilityDelegate();
            }
    ...
    protected void positionSelector( int position, View sel ) {
        ...
        if ( sel instanceof AbsHListView.SelectionBoundsAdjuster) {
            ( (AbsHListView.SelectionBoundsAdjuster) sel ).adjustListItemSelectionBounds( selectorRect );
        }
        ...
        if ( selector != null && ( isFocused() || touchModeDrawsInPressedState() )
            ...
            if ( longClickable && !mDataChanged ) {
                if ( mPendingCheckForKeyLongPress == null ) {
                    mPendingCheckForKeyLongPress = new AbsHListView.CheckForKeyLongPress();
                }
    ...
    protected void onAttachedToWindow() {
        ...
        if ( mAdapter != null && mDataSetObserver == null ) {
            mDataSetObserver = new AbsHListView.AdapterDataSetObserver();
    ...
    private class PerformClick extends AbsHListView.WindowRunnnable implements Runnable {
    ...
    private class CheckForLongPress extends AbsHListView.WindowRunnnable implements Runnable {
    ...
    private class CheckForKeyLongPress extends AbsHListView.WindowRunnnable
            implements Runnable {
                    ...
                    if ( !mDataChanged ) {
                        ...
                        if ( longClickable ) {
                            if ( mPendingCheckForLongPress == null ) {
                                mPendingCheckForLongPress = new AbsHListView.CheckForLongPress();
                            }
    ...
    private boolean startScrollIfNeeded( int x ) {
        ...
        if ( overscroll || distance > mTouchSlop ) {
            ...
            reportScrollStateChange( AbsHListView.OnScrollListener.SCROLL_STATE_TOUCH_SCROLL );
    ...
    public boolean onTouchEvent( MotionEvent ev ) {
        ...
        if ( !mIsAttached ) {
            ...
            // Since we rely on being attached to get data setter change notifications,
                        ...
                        if ( !mDataChanged ) {
                            if ( ( mTouchMode != TOUCH_MODE_FLING ) && ( motionPosition >= 0 )
                                ...
                                if ( mPendingCheckForTap == null ) {
                                    mPendingCheckForTap = new AbsHListView.CheckForTap();
                                }
                ...
                switch ( mTouchMode ) {
                    ...
                    case TOUCH_MODE_DONE_WAITING:
                        ...
                        if ( child != null && !child.hasFocusable() && inList ) {
                            ...
                            if ( mPerformClick == null ) {
                                mPerformClick = new AbsHListView.PerformClick();
                            }
                    ...
                    case TOUCH_MODE_SCROLL:
                        ...
                        if ( childCount > 0 ) {
                            ...
                            if ( mFirstPosition == 0 && firstChildLeft >= contentLeft && mFirstPosition + childCount < mItemCount
                                ...
                                mTouchMode = TOUCH_MODE_REST;
                                reportScrollStateChange( AbsHListView.OnScrollListener.SCROLL_STATE_IDLE );
                            } else {
                                ...
                                if ( Math.abs( initialVelocity ) > mMinimumVelocity
                                        ...
                                        !( ( mFirstPosition == 0 &&
                                                ...
                                                + mOverscrollDistance ) ) ) {
                                    if ( mFlingRunnable == null ) {
                                        mFlingRunnable = new AbsHListView.FlingRunnable();
                                    }
                                    reportScrollStateChange( AbsHListView.OnScrollListener.SCROLL_STATE_FLING );
    ...
    protected float getHorizontalScrollFactor() {
        if ( mHorizontalScrollFactor == 0 ) {
            ...
            boolean success = getContext().getTheme().resolveAttribute( it.sephiroth.android.library.R.attr.hlv_listPreferredItemWidth, outValue, true );
    ...
    /**
     * Fires an "on scroll state changed" event to the registered {@link AbsHListView.OnScrollListener}, if any.
    ...
    public void smoothScrollToPosition( int position ) {
        if ( mPositionScroller == null ) {
            mPositionScroller = new AbsHListView.PositionScroller();
        }
    ...
    /**
     * Why the hell Google guys setter public methods hidden??? fuck you
     */
     ...
     *
     * @return Whether selection was setter to something.
     */
    ...
    protected ViewGroup.LayoutParams generateLayoutParams( ViewGroup.LayoutParams p ) {
        return new AbsHListView.LayoutParams( p );
    }

    @Override
    public AbsHListView.LayoutParams generateLayoutParams(AttributeSet attrs ) {
    ...
    /**
     * When setter to a non-zero value, the cache color hint indicates that this list is always drawn on top of a solid, single-color,
     * opaque background.
     *
     * Zero means that what's behind this object is translucent (non solid) or is not made of a single color. This hint will not
     * affect any existing background drawable setter on this view ( typically setter via {@link #setBackgroundDrawable(Drawable)}).
     *
     * @param color
    ...
    public void reclaimViews( List<View> views ) {
        int childCount = getChildCount();
        AbsHListView.RecyclerListener listener = mRecycler.mRecyclerListener;
    ...
    /**
     * Sets the recycler listener to be notified whenever a View is setter aside in the recycler for later reuse. This listener can be
     * used to free resources associated to the View.
     *
     * @param listener
     *           The recycler listener to be notified of views setter aside in the recycler.
     *
     * @see AbsHListView.RecycleBin
     * @see AbsHListView.RecyclerListener
     */
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams {
        ...
        /**
         * When this boolean is setter, the view has been added to the AbsListView at least once. It is used to know whether
     ...
     *
     * @see AbsHListView.RecycleBin
     * @see AbsHListView#setRecyclerListener(AbsHListView.RecyclerListener)
     */
