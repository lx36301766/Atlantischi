...
public abstract class AdapterView<T extends Adapter> extends ViewGroup {
    ...
    /**
     * Width of the view when mSyncPosition and mSyncColId where setter
     */
    ...
    /**
     * The position within the adapter's data setter of the item to select during the next layout.
     */
    ...
    /**
     * The position within the adapter's data setter of the currently selected item.
     */
    @ViewDebug.ExportedProperty(category = "list")
    ...
    /**
     * When setter to true, calls to requestLayout() will not propagate up the parent hierarchy. This is used to layout the children
    ...
    /**
     * @return The callback to be invoked with an item in this AdapterView has been clicked, or null id no callback has been setter.
     */
    ...
    /**
     * Return the position of the currently selected item within the adapter's data setter
     *
    ...
    /**
     * Get the position within the adapter's data setter for the view, where view is a an adapter item or a descendant of an adapter
     * item.
     *
     * @param view
     *           an adapter item, or a descendant of an adapter item. This must be visible in this AdapterView at the time of the
     *           call.
     * @return the position within the adapter's data setter of the view, or {@link #INVALID_POSITION} if the view does not correspond
    ...
    /**
     * Returns the position within the adapter's data setter for the first item displayed on screen.
     *
     * @return The position within the adapter's data setter
     */
    ...
    /**
     * Returns the position within the adapter's data setter for the last item displayed on screen.
     *
     * @return The position within the adapter's data setter
     */
    ...
    protected void checkFocus() {
        ...
        // The order in which we setter focusable in touch mode/focusable may matter
        ...
        if ( mOnItemSelectedListener != null
            ...
            if ( mInLayout || mBlockLayoutRequests ) {
                ...
                if ( mSelectionNotifier == null ) {
                    mSelectionNotifier = new AdapterView.SelectionNotifier();
                }
