...
import com.jm.jiedian.mapadapter.separate.gaode.IGaodeUISettings
...
internal class GaodeUISetting (var uiSettings: UiSettings) : IGaodeUISettings {
    ...
    override fun setZoomInByScreenCenter(zoomIn: Boolean) {
        uiSettings.setZoomInByScreenCenter(zoomIn)
    }
