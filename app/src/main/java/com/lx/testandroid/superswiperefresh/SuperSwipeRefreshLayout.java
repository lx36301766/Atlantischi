...
public class SuperSwipeRefreshLayout extends ViewGroup {
    ...
    private static final int HEADER_VIEW_HEIGHT = 65;// HeaderView height (dp)
    ...
    private void startScaleDownAnimation(AnimationListener listener) {
        ...
        mHeadViewContainer.setAnimationListener(listener);
        mHeadViewContainer.clearAnimation();
//        mHeadViewContainer.startAnimation(animation);
    ...
    private void animatorFooterToBottom(int start, final int end) {
        ...
        valueAnimator.addUpdateListener(new AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                // update
                Log.d("ValueAnimator", "onAnimationUpdate, pushDistance=" + pushDistance);
