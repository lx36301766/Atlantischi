...
final class JsonValueReader extends JsonReader {
  ...
  JsonValueReader(Object root) {
    scopes[stackSize] = com.squareup.moshi.JsonScope.NONEMPTY_DOCUMENT;
  ...
  @Override public void beginArray() throws IOException {
    ...
    scopes[stackSize - 1] = com.squareup.moshi.JsonScope.EMPTY_ARRAY;
  ...
  @Override public void beginObject() throws IOException {
    ...
    stack[stackSize - 1] = iterator;
    scopes[stackSize - 1] = com.squareup.moshi.JsonScope.EMPTY_OBJECT;
